...
def  function2():
     ...
     x = np.arange(10, 37, dtype =float).reshape((3,3,3))
     print(x)
     print(x.dtype)
     return x
function2()
...
def function3():
    ...
    a = np.arange(1, 100 * 10 + 1)
    x = list(filter(lambda x: x % 35 == 0, a))
    print(x)
function3()
